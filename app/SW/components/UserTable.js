...
// function UserTable({ users, sortColumn, sortDirection, handleSort, handleUpdate, handleDelete, handleFileUpload, handleButtonClick }) {
//     const [isDocsNumberVisible, setDocsNumberVisible] = useState(true); // '문서번호' 컬럼의 가시성을 관리하는 상태 추가
//     const [isEtcVisible, setEtcVisible] = useState(true); // '기타내역' 컬럼의 가시성을 관리하는 상태 추가
...
//         setEtcVisible(prev => !prev); // '기타내역' 토글 함수
//     };
...
//                         {isEtcVisible && ( // '기타내역' 컬럼의 가시성 조건부 렌더링
//                             <TableCell className='table-header'>
//                                 <TableSortLabel
//                                     active={sortColumn === 'etc'}
//                                     direction={sortColumn === 'etc' ? sortDirection : 'asc'}
