...
export default function Network() {
  return (
    ...
    <Accordion defaultExpanded>
      ...
      <AccordionDetails>
        <List>
          <ListItem className="typo-sidebar" component={Link} href="/network/troubleshooting">
            {/* <ListItemText primary="temp" /> */}
            <Typography className="typo-sidebar" component="span">장애 등록</Typography> {/* 스타일 적용 */}
          </ListItem>
          <Divider />

          <ListItem className="typo-sidebar" component={Link} href="/network/troubleshooting2">
            {/* <ListItemText primary="temp" /> */}
            <Typography className="typo-sidebar" component="span">장애 등록2</Typography> {/* 스타일 적용 */}
          </ListItem>
          <Divider />
          ...
          {/* <ListItem className="typo-sidebar" component={Link} href="/imgtable">
            <Typography className="typo-sidebar" component="span">첨부파일</Typography> 
          </ListItem>
          <Divider />
          ...
          <ListItem className="typo-sidebar" component={Link} href="/test/chartStack">
            <Typography className="typo-sidebar" component="span">사용현황 차트</Typography> 
          </ListItem>
          <Divider /> */}
